        ...
        <form className="flex flex-col space-y-2">
            ...
            <div>
                ...
                <div className="flex gap-2">
                    <input className="w-full rounded-lg border p-2" type="text" placeholder="Add photos using a link . . . jpg"></input>
                    <button className="bg-primary text-white rounded-2xl p-2 px-4">Add photo</button>
                </div>

                <div className="mt-2 grid grid-cols-3 md:grid-cols-4 lg:grid-cols-6">
                    <button className="flex justify-center items-center border bg-transparent rounded-2xl p-8 text-md text-gray-600">
